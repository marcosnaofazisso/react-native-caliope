...
const avatarDeborah = require('../assets/deborah@caliope.com.br.png')
const avatarMarcelo = require('../assets/marcelo@caliope.com.br.png')

const avatarArnaldo = require('../assets/arnaldo@caliope.com.br.png')
const avatarHenrique = require('../assets/henrique@caliope.com.br.png')
const avatarThiago = require('../assets/thiago@caliope.com.br.png')

const avatarPadrao = require('../assets/avatar-menu.png')


export const fotosDosUsuariosTeste = {
    ...
    'deborah@caliope.com.br': avatarDeborah,
    'marcelo@caliope.com.br': avatarMarcelo,

    'arnaldo@caliope.com.br': avatarArnaldo,
    'henrique@caliope.com.br': avatarHenrique,
    'thiago@caliope.com.br': avatarThiago,
